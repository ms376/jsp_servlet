...
<body>
	...
	<%-- 액션 태그를 통해 공톨잉크로 사용할 페이지를 인클루드하여 해당
	문서에 포함시긴다. --%>
	...
	<!-- 
		...
		에러메세지를 화면에 출력한다.
		해당 속성값은 로그인처리 페이지에서 회원정보를 DB에서 찾지 못한
	...
	*/
	...
	<!-- 
		폼값 전송을 위한 <form>태그로 전송할 URL, 전송방식, 폼의이름, submit
		이벤트 리스너로 구성한다. 특히 폼값 검증을 위한 validateForm 함수 호출시
		<form>태그의 DOM을 인수로 전달
	 -->
